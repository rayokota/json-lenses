...
public class JsonLensesExecutorTest {
    ...
    public void testRuleExecutor() throws Exception {
        ...
        RuleContext ctx = new RuleContext(null, null, null, null, null, null, false, RuleMode.UPGRADE, rule);
        ...
        ctx = new RuleContext(null, null, null, null, null, null, false, RuleMode.DOWNGRADE, rule);
